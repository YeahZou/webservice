 ...
 * 
 */
@WebServiceClient(name = "MyWebServiceImplService", targetNamespace = "http://server.soap.webservice.yeah.com/", wsdlLocation = "http://localhost:1234/webService/webservicetest?wsdl")
    ...
    extends Service
{
    ...
    private final static QName MYWEBSERVICEIMPLSERVICE_QNAME = new QName("http://server.soap.webservice.yeah.com/", "MyWebServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:1234/webService/webservicetest?wsdl");
    ...
    public MyWebService getMyWebServiceImplPort() {
        return super.getPort(new QName("http://server.soap.webservice.yeah.com/", "MyWebServiceImplPort"), MyWebService.class);
    }
    ...
    public MyWebService getMyWebServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.soap.webservice.yeah.com/", "MyWebServiceImplPort"), MyWebService.class, features);
    }
